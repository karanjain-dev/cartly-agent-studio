# Cartly Agent Studio — Technical Architecture

This document contains implementation details moved out of the repository
landing page. For the plain-language overview, see [`README.md`](../README.md).
