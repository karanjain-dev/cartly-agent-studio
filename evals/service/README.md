...
The public website still uses its existing runtime; this service is a local API
milestone, not a deployed replacement.

## Try the first working increment

From the desktop project (or `evals/` in the GitHub checkout):
