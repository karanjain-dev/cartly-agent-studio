...
RATES = {'gpt-6-astra':{'input':10,'cached':1,'cache_write':12.5,'output':50},
...
def cost(model,usage):
    ...
    if inputs>272000 and family=='gpt-6-astra':raise ValueError('Long-context pricing not configured for this baseline')
